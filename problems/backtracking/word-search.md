...
<img src="https://intervu.dev/blog/images/word-search-viz.png" alt="3×4 character grid with DFS path A→B→C→C→E→D highlighted in teal, showing the backtracking search path for 'ABCCED'." style="max-width: 380px; width: 100%; height: auto;" />
