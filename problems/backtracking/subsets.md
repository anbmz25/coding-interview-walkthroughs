...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=subsets)**
...
- **Practice**: [Mock interview for Subsets](https://intervu.dev/start-mock-interview?problem=subsets)
