...
<img src="https://intervu.dev/blog/images/implement-trie-viz.png" alt="Trie with root→a→p→p→l→e. Node 'p' marked as end (for 'app'), node 'e' marked as end (for 'apple')."  width="300" />
