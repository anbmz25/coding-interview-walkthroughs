...
<img src="https://intervu.dev/blog/images/merge-two-sorted-lists-viz.png" alt="List 1: 1→2→4. List 2: 1→3→4. Merged result: 1→1→2→3→4→4." style="max-width: 440px; width: 100%; height: auto;" />
