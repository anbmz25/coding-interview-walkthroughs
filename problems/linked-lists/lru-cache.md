...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=lru-cache)**
...
<img src="https://intervu.dev/blog/images/lru-cache-viz.png" alt="Doubly linked list after put(1,1), put(3,3), put(4,4) with bidirectional arrows between sentinel head (LRU) and tail (MRU), nodes 1, 3, 4."  width="440" />
...
- **Practice**: [Mock interview for LRU Cache](https://intervu.dev/start-mock-interview?problem=lru-cache)
