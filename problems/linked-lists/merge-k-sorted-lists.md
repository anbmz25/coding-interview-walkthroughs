...
<img src="https://intervu.dev/blog/images/merge-k-sorted-lists-viz.png" alt="Three sorted linked lists L1=[1,4,5], L2=[1,3,4], L3=[2,6] merging into a single sorted list [1,1,2,3,4,4,5,6]." style="max-width: 440px; width: 100%; height: auto;" />
