...
<img src="/blog/images/invert-binary-tree-viz.png" alt="Before: binary tree with root 4, left subtree 2→(1,3), right subtree 7→(6,9). After: mirrored tree with root 4, left subtree 7→(9,6), right subtree 2→(3,1)." style="max-width: 680px; width: 100%; height: auto;" />
