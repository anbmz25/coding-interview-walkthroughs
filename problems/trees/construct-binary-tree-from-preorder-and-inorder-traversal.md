...
<img src="/blog/images/construct-binary-tree-viz.png" alt="Binary tree [3,9,20,null,null,15,7] reconstructed from preorder=[3,9,20,15,7] and inorder=[9,3,15,20,7]. Root node 3 is highlighted." style="max-width: 380px; width: 100%; height: auto;" />
