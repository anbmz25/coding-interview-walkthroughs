...
<img src="https://intervu.dev/blog/images/lowest-common-ancestor-viz.png" alt="Binary tree [3,5,1,6,2,0,8,null,null,7,4] with node 5 highlighted as LCA of p=5 and q=4. The path from node 5 down to node 4 through node 2 is highlighted in teal."  width="440" />
