...
<img src="https://intervu.dev/blog/images/diameter-of-binary-tree-viz.png" alt="Binary tree [1,2,3,4,5] with the diameter path 4→2→1→3 (3 edges) highlighted in teal."  width="380" />
...
*Already comfortable with the solution? [Practice it in a mock interview →](https://intervu.dev/start-mock-interview?problem=diameter-of-binary-tree)*
