...
<img src="/blog/images/lowest-common-ancestor-bst-viz.png" alt="BST [6,2,8,0,4,7,9] with node 6 highlighted as the split point LCA of p=2 and q=8. Edges from root to both children highlighted in teal." style="max-width: 380px; width: 100%; height: auto;" />
