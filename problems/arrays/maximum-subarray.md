...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=maximum-subarray)**
...
- **Practice**: [Mock interview for Maximum Subarray](https://intervu.dev/start-mock-interview?problem=maximum-subarray)
