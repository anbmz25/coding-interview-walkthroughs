...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=two-sum)**
...
- **Practice**: [Mock interview for Two Sum](https://intervu.dev/start-mock-interview?problem=two-sum)
