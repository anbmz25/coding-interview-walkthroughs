...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=merge-intervals)**
...
- **Practice**: [Mock interview for Merge Intervals](https://intervu.dev/start-mock-interview?problem=merge-intervals)
