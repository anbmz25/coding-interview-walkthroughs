...
**[Practice in a mock interview →](https://intervu.dev/start-mock-interview?problem=course-schedule)**
...
- **Practice**: [Mock interview for Course Schedule](https://intervu.dev/start-mock-interview?problem=course-schedule)
